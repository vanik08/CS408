...
/**
 * Initializes the document without setters or marking anymessage modified.
 *
 ...
 * ####Example
 *
 *     Message.findOne().select('name').exec(function (err, doc) {
    ...
    Object.defineProperty(prototype, prop, {
      ...
      , get: function () {
          ...
          if (!this.$__.getters[path]) {
            ...
            // message.nested.nested.nested... doesn't occur (gh-366)
            var i = 0
              , len = keys.length;
