 ...
 * ####Example
 *
 *     Message.find().where('age').gt(21)
 *
 *     // or
 *     Message.find().gt('age', 21)
 *
 ...
 *     Message.find({ name: /^hello/ }).stream().pipe(res)
 *
 *     // manual streaming
 *     var stream = Message.find({ name: /^hello/ }).stream();
 *
 *     stream.on('data', function (doc) {
 *       // do somemessage with the mongoose document
 ...
 *     var stream = Message.find().stream({ transform: JSON.stringify });
