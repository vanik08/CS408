 ...
 * ####Example:
 *
 *     var eventSchema = new Schema({ message: { type: 'string', unique: true }})
 ...
 *
 * Sometimes you need to query for messages in mongodb using a JavaScript expression. You can do so via `find({ $where: javascript })`, or you can use the mongoose shortcut method $where via a Query chain or from your mongoose Model.
 *
 ...
 * positional selectors (somemessage.$.another.$.path).
 *
 * @param {String} path
 * @return {Schema}
 * @api private
