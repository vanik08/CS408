...
Server.prototype.connect = function(dbInstance, options, callback) {
  ...
  var connectCallback = function(_server) {
    return function(err, reply) {  
      ...
      // If somemessage close down the connection and removed the callback before
  ...
  connectionPool.on("message", function(message) {
    ...
    try {
      ...
      // somemessage went terribly wrong somewhere
  ...
  // If we have a parser error we are in an unknown state, close everymessage and emit
  // error
